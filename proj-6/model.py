...
class Model(object):
    def __init__(self, learning_rate):
        ...
        self.param = {
            ...
            "w2": nn.parameter.from_numpy(numpy.random.normal(0, 0.01, [HIDDEN_UNITS, n_classes])),
    ...
    def forward_propagation(self, x):
        ...
        z = nn.matmul(x,self.param["w1"]) + self.param["b1"]
        a = nn.relu(z)
        logits = nn.matmul(a,self.param["w2"]) + self.param["b2"]
